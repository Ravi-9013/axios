// Axios Global
axios.defaults.headers.common['X-Auth-Token']='getsometoken'
...
function getTodos() {
  ...
  ( config=>{console.log(`${config.method.toUpperCase()} request sent to ${config.url} at ${new Date().toLocaleTimeString()}`)
  return config},
  error=>{
